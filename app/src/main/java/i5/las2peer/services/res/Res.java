...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "377", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg2/microservice-377/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiOperation(value = "p", notes = " ")
  public Response p(String body) {
